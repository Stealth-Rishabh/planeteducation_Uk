...
export default function Testimonials() {
  ...
  return (
    <section className="relative h-[1000px] sm:h-auto py-16 md:py-20 px-4 overflow-hidden bg-gradient-to-b from-white to-blue-50">
      ...
      <div className="absolute top-0 left-0 w-64 h-64 bg-blue-100 rounded-full opacity-30 -translate-x-1/2 -translate-y-1/2" style={{ filter: 'blur(60px)' }} />
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-indigo-100 rounded-full opacity-30 translate-x-1/2 translate-y-1/2" style={{ filter: 'blur(60px)' }} />
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover how our students achieved their academic dreams with our support and guidance
          </p>
        </div>
        ...
        <div className="relative py-28 w-full max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div
              ...
              style={{ transform: `translate(${(index - activeIndex) * 100}%, -50%)` }}
            >
              <div className="bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-2xl overflow-hidden">
                <div className="flex flex-col md:flex-row items-center gap-8 p-8">
                  <div className="relative group">
                    ...
                    <svg className="absolute top-4 right-4 w-8 h-8 text-white/80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 21C3 16.5 6.5 13 11 13V7C5.5 7 1 11.5 1 17V21H3ZM13 21C13 16.5 16.5 13 21 13V7C15.5 7 11 11.5 11 17V21H13Z" fill="currentColor"/>
                    </svg>
                  </div>
          ...
          >
            <svg className="h-3 w-3 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${
                index === activeIndex ? 'bg-blue-600 w-6' : 'bg-blue-200 hover:bg-blue-300'
              }`}
